...
@property (assign,nonatomic) unsigned long long currentDirectoryIndex;                       //@synthesize currentDirectoryIndex=_currentDirectoryIndex - In the implementation block
...
@property (assign,nonatomic) unsigned long long currentQueryIndex;                           //@synthesize currentQueryIndex=_currentQueryIndex - In the implementation block
...
-(void)setCurrentQueryIndex:(unsigned long long)arg1 ;
-(void)loadNextDatabase;
-(unsigned long long)currentQueryIndex;
...
-(unsigned long long)currentDirectoryIndex;
-(void)setTestState:(int)arg1 ;
-(void)setCurrentDirectoryIndex:(unsigned long long)arg1 ;
-(int)testState;
