...
@class NSMutableArray, NSMutableDictionary, SBAppSwitcherScrollView, UITapGestureRecognizer, SBStopScrollingGestureRecognizer, SBDisplayItem, NSArray, NSString;
