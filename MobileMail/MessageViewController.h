...
-(BOOL)_hasShortWideLayout;
-(MFModernAddressAtom *)atomPresentingPersonView;
-(void)hideModalViewController:(id)arg1 ;
-(void)displayViewController:(id)arg1 fromAtom:(id)arg2 allowsEditing:(BOOL)arg3 ;
...
-(void)markConversationContainingMessage:(id)arg1 shouldNotify:(BOOL)arg2 ;
...
-(BOOL)_traitCollectionIsShortWideLayout:(id)arg1 ;
