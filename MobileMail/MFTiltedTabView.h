...
@class UIPanGestureRecognizer, UILongPressGestureRecognizer, UITapGestureRecognizer, UIScrollView, NSMutableArray, NSMutableSet, _TabGradientView, _MFTiltedTabItem, _MFTouchDownTapRecognizer, CADisplayLink, NSArray, UIImage, UIView, UIMotionEffectGroup, NSString;
...
-(void)_updateSpringAnimationForView:(id)arg1 withFrame:(CGRect)arg2 transform:(CATransform3D)arg3 zPosition:(double)arg4 opacity:(double)arg5 verticalScrollAdjustment:(double)arg6 animated:(BOOL)arg7 ;
