...
@property (assign,nonatomic) BOOL showingErrorPage;                                                                 //@synthesize showingErrorPage=_showingErrorPage - In the implementation block
...
@property (assign,getter=isRestoringSessionState,nonatomic) BOOL restoringSessionState;                             //@synthesize restoringSessionState=_restoringSessionState - In the implementation block
@property (assign,nonatomic) unsigned long long lastRenderTreeSize;                                                 //@synthesize lastRenderTreeSize=_lastRenderTreeSize - In the implementation block
...
-(unsigned long long)lastRenderTreeSize;
...
-(id)fileDownload:(id)arg1 decideDestinationWithSuggestedFilename:(id)arg2 allowOverwrite:(BOOL*)arg3 ;
...
-(void)setLastRenderTreeSize:(unsigned long long)arg1 ;
...
-(void)setRestoringSessionState:(BOOL)arg1 ;
