...
@property (assign,nonatomic) long long _currentLightLevel;                                                        //@synthesize currentLightLevel=_currentLightLevel - In the implementation block
...
-(void)set_currentLightLevel:(long long)arg1 ;
