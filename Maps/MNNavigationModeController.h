...
@interface MNNavigationModeController : NSObject <UIActionSheetDelegate, UIAlertViewDelegate, UIGestureRecognizerDelegate, MNNavigationDebugViewsControllerDelegate, MNNavigationOverviewBarDelegate, MNGuidanceCurrentRoadDisplayDelegate, MapsChromeModeController, MainChromeModeController, StarkChromeModeController, MNLockScreenLayerSource, DirectionsStepsTableViewControllerDelegate, UIPopoverControllerDelegate, MNNavigationSessionUIDelegate, MNNavigationDisplayDelegate, MNGuidanceSignsDisplayDelegate> {
	...
	BOOL _isPendingReinsertionInViewHierarchy;
...
-(void)_dismissNavWithDestination:(long long)arg1 animated:(BOOL)arg2 ;
-(void)endNavModeAnimated:(BOOL)arg1 isNavigationEnding:(BOOL)arg2 ;
-(void)_endNavModeAnimated:(BOOL)arg1 isNavigationEnding:(BOOL)arg2 destination:(long long)arg3 ;
...
-(void)_cancelEtaAlert:(BOOL)arg1 ;
-(void)_cleanupEtaAlert:(BOOL)arg1 ;
