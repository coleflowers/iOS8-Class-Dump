...
@property (assign,getter=isPendingSearchResults,nonatomic) BOOL pendingSearchResults;                  //@synthesize pendingSearchResults=_pendingSearchResults - In the implementation block
...
-(void)setPendingSearchResults:(BOOL)arg1 ;
